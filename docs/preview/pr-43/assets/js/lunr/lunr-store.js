var store = [{
        ...
        "excerpt":" ","categories": [],
        "tags": [],
        "url": "/preview/pr-43/members/hitomi_kinoshita/",
        "teaser": null
      },{
        "title": "Kai_nakaishi",
        "excerpt":" ","categories": [],
        ...
        "excerpt":"ここに文章 原知正, 栗田宙人, 今泉允聡, 乾健太郎, 横井祥. なぜ平均プーリングはうまく動くのか？テキスト埋め込みの二次統計量の崩壊の定量化. ポスター発表, 言語処理学会第32回年次大会 (NLP 2026). 宇都宮, 2026年3月. 論文 石峯拓海, 日野英逸, 横井祥. 単体複体を用いた次単語予測分布の幾何的解釈. ポスター発表, 言語処理学会第32回年次大会 (NLP 2026). 宇都宮, 2026年3月. 論文 木谷頼斗, 大橋諭貴, 佐藤宏亮, 鴨田豪, 高橋良允, 山本悠士, 塩野大輝, 坂口慶祐, 小林悟郎. Attention Sink および Massive Activation の発生機序の分解. 口頭発表, 言語処理学会第32回年次大会 (NLP 2026). 宇都宮, 2026年3月. ポスター発表, 言語処理学会第32回年次大会 (NLP 2026)....","categories": ["News"],
        "tags": [],
